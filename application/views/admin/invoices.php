                ...
                <div class="panel panel-default border-panel card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        ...
                        <div class="form-inline mb-30 collapse" id="filterElement">
                                ...
                                <div class="form-group mr-15">
                                        <button type="button" name="applyAdminInvoiceFilter" id="applyAdminInvoiceFilter" class="btn btn-primary">Apply</button>
                                </div>
                                <div class="form-group mr-15">
                                        <button type="button" name="resetAdminInvoiceFilter" id="resetAdminInvoiceFilter" class="btn btn-default">Clear</button>
                                </div>
                            </div>  
                            <table id="AdminInvoiceDataTable" class="table">
                                <thead>
                                    <tr>
                                        <th>#Invoice</th>
                                        <th>Client</th>
