                ...
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        ...
                        <div class="pull-right">
                            <a class="btn btn-default btn-sm" href="<?php echo base_url();?>admin/support">Back</a>
                            <div class="btn-group">
                                <div class="dropdown">
                                    <button class="btn btn-sm btn-outline btn-primary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                                    Select State
                                    <span class="caret"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li><a href="<?php echo base_url();?>admin/update_ticket_state?state=closed&ticket_id=<?php echo $this->hasher->encrypt($ticket_details->supprt_ticket_id);?>">Closed</a></li>
                                        <li><a href="<?php echo base_url();?>admin/update_ticket_state?state=re-Open&ticket_id=<?php echo $this->hasher->encrypt($ticket_details->supprt_ticket_id);?>">Re-Open</a></li>
                                        <li><a href="<?php echo base_url();?>admin/update_ticket_state?state=pending&ticket_id=<?php echo $this->hasher->encrypt($ticket_details->supprt_ticket_id);?>">Pending</a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div class="panel-wrapper collapse in">
                                            <div class="panel-body pa-0">
                                                ...
                                                <div class="input-group">
                                                   <?php $attribute = array("id" => "chatAdminForm");?>
