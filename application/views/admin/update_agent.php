           ...
           <div class="col-sm-12 col-xs-12">
            <div class="panel panel-default border-panel card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Update Agent</h6>
                    </div>
                ...
                <div class="panel-wrapper collapse in">
                    ...
                    <?php echo form_open('admin/save_agent', $attribute);?>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="email" class="form-control required" name="email" id="email" autocomplete="off" value="<?php echo $user->email;?>">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control required" id="subscription_id" name="subscription_id" required>
                                        <?php foreach($subscriptions as $subscription):?>
                                            <option value="<?php echo $subscription->subscription_id;?>" <?php echo ($subscription->subscription_id == $user->subscription_id) ? 'selected' : '';?>><?php echo $subscription->title;?></option>
                                        <?php endforeach;?>
                                    </select>
