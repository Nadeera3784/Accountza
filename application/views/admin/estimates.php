                ...
                <div class="panel panel-default border-panel card-view">
                    ...
                    <div class="panel-wrapper collapse in">
                        ...
                        <div class="form-inline mb-30 collapse" id="filterElement">
                                ...
                                <div class="form-group mr-15">
                                        <button type="button" name="applyAdminEstimatesFilter" id="applyAdminEstimatesFilter" class="btn btn-primary">Apply</button>
                                </div>
                                <div class="form-group mr-15">
                                        <button type="button" name="resetAdminEstimatesFilter" id="resetAdminEstimatesFilter" class="btn btn-default">Clear</button>
                                </div>
                            </div>  
                            <table id="AdminEstimatesDataTable" class="table">
                                <thead>
                                    <tr>
                                        <th>Estimate No</th>
                                        <th>Client</th>
