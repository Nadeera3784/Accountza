            ...
            <div class="col-sm-12 col-xs-12 animate-element">
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <span class="panel-title txt-dark mr-10">Invoice -  <span class="label label-primary"><?php echo $invoice->invoice_no;?></span></span>
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="center-block text-center mb-10">
                                    <!-- <button type="button" id="printInvoice"  class="btn btn-default btn-sm">Print</button> -->
                                    <a class="btn btn-default btn-sm" href="<?php echo base_url();?>agent/download_invoice/<?php echo $this->hasher->encrypt($invoice->invoice_id);?>">Download</a>
                                    <a class="btn btn-default btn-sm" href="<?php echo base_url();?>agent/send_invoice/<?php echo $this->hasher->encrypt($invoice->invoice_id);?>">Send</a>
                                    <a class="btn btn-default btn-sm" href="<?php echo base_url();?>agent/update_invoice/<?php echo $this->hasher->encrypt($invoice->invoice_id);?>">Edit</a>
                                </div>
                                   ...
                                   <div class="col-xs-6">
                                    ...
                                    <div class="col-xs-6 mt-25">
                                        ...
                                        <address class="mb-15">
                                            ...
                                            <span title="Phone"></span><span id="remoteClientPhone"><?php echo $invoice->phone;?></span>
                                        </address>
                                    </div>
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-hover">
                                                ...
                                                <tr class="txt-dark">
                                                        ...
                                                        <td>Subtotal</td>
                                                        <td id="subtotal"><?php echo get_currency_symbol($settings->company_currency) ."". currency_format($invoice->invoice_subtotal);?></td>
                                                    </tr>
                                                    <tr class="txt-dark">
                                                        <td></td>
                                                        <td></td>
                                                        <td>Discount(%)</td>
                                                        <td id="discount"><?php echo $invoice->invoice_discount;?></td>
                                                    </tr>
                                                    <tr class="txt-dark">
                                                        <td></td>
                                                        <td></td>
                                                        <td>Total</td>
                                                        <td id="amounttotal"><?php echo get_currency_symbol($settings->company_currency) ."". currency_format($invoice->invoice_total);?></td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
