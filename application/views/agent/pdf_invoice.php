...
<div class="container">
  ...
  <h1>Invoice</h1>
  <p class="ls-5">
        <span>Reference&nbsp; :  <?php echo $invoice->invoice_no;?></span> <br>
        <span>Billing Date : <?php echo $invoice->invoice_issue;?></span> <br>
        <span>Due Date &nbsp;&nbsp;   : <?php echo $invoice->invoice_due;?></span> <br>
    </p>
...
<div class="container pt-50">
  ...
  <span class="txt-dark head-font inline-block uppercase-font mb-5">Customer Details:</span>
   <p class="ls-5">
        <span class="address-head mb-5"><?php echo $invoice->name;?></span>
        <span><?php echo $invoice->address;?></span> <br>
        <span><?php echo $invoice->city;?>, <?php echo $invoice->state;?> <?php echo $invoice->postal_code;?></span> <br>
        <span title="Phone"></span><span><?php echo $invoice->phone;?></span>
    </p>
  </div>
...
<table width="100%" class="table pt-20">
    ...
    <tfoot>
        <tr>
          ...
          <td class="txt-dark"><?php echo get_currency_symbol($settings->company_currency) ."". currency_format($invoice->invoice_subtotal);?></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td class="txt-dark">Discount(%)</td>
          <td class="txt-dark"><?php echo $invoice->invoice_discount;?></td>
        </tr>
        <tr>
          <td></td>
          <td></td>
          <td class="txt-dark">Total(<?php echo $settings->company_currency;?>)</td>
          <td class="txt-dark"><?php echo get_currency_symbol($settings->company_currency) ."". currency_format($invoice->invoice_total);?></td>
        </tr>
    </tfoot>
  </table>
  ...
  <div class="container pt-20">
   <div class="float-left-block_01">
     ...
     <p><?php echo nl2br($invoice->payment_info);?><p>
  </div>
  <div class="float-right-block_01">
     <span class="txt-dark head-font inline-block uppercase-font mb-5">Note</span>
