            ...
            <div class="col-sm-12 col-xs-12 animate-element">
                <div class="panel panel-default border-panel card-view">
                    <div class="panel-heading">
                        <div class="pull-left">
                            <h6 class="panel-title txt-dark">Update Mindmap</h6>
                        </div>
                        ...
                        <div class="panel-body">
                            <div class="row">
                              <?php $attribute = array("id" => "genericFormValidation");?>
                               <?php echo form_open('agent/save_mindmap', $attribute);?>
                               <textarea style="display: none" id="mindmap_content" name="mindmap_content"><?php echo $mindmap->mindmap_content ;?></textarea>
                               <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="title">Title:</label>
                                        <input type="text" class="form-control required" id="title" name="title" value="<?php echo $mindmap->mindmap_title;?>">
                               ...
                               <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea id="description" name="description" class="form-control required" rows="4"><?php echo $mindmap->mindmap_description;?></textarea>
                               ...
                               <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group pull-right"> 
                                        <input type="hidden" id="id" name="id" value="<?php echo $this->hasher->encrypt($mindmap->mindmap_id);?>">
