 ...
 */
$config['site_title']                 = "Accountza.io";       // Site Title, example.com
$config['admin_email']                = "noreply@accountza.io"; // Admin Email, admin@example.com
...
$config['message_start_delimiter'] = '<div class="alert alert-primary  alert-dismissible" role="alert">'; 	// Message start delimiter
$config['message_end_delimiter']   = '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>'; 
$config['error_start_delimiter']   = '<div class="alert alert-primary  alert-dismissible" role="alert">';		// Error message start delimiter
$config['error_end_delimiter']     = '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button></div>';	// Error message end delimiter
